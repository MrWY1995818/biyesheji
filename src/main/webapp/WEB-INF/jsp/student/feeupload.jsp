...
<head>
    ...
    <script src="https://heerey525.github.io/layui-v2.4.3/layui-v2.4.4/layui.js"></script>
</head>
                    ...
                    <form class="form-horizontal" method="post" action="<c:url value="/student/uploadfee"/>"
                        ...
                        <table class="layui-table" lay-size="lg">
                            ...
                            <tbody>
                             <tr>
                                <td>宿舍名</td>
                                <td><input type="text" readonly value="${feeup.name}" name="name"  placeholder="1#207" title="" style="width:100px;height:30px;"> </input></td>
                            </tr>
                            <tr>
                                <td>水费</td>
                                <td><input type="text" placeholder="还剩下${feeup.water}元" name="water" title="" style="width:100px;height:30px;"> </input></td>
                            </tr>
                            <tr>
                                <td>电费</td>
                                <td><input type="text" name="power"placeholder="还剩下${feeup.power}" class="input-xlarge" style="width:100px;height:30px;"></td>
                            </tr>
